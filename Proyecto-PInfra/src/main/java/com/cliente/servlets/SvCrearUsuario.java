...
//		String fechaNacimiento = request.getParameter("fechaNacimiento");
		...
		Usuario oUsuarioNuevo = new Usuario(clave, documento, new Date(), mailInstitucional,
				mailPersonal, nombreUsuario, primerApellido, primerNombre,
				segundoApellido, segundoNombre, telefono, "S", "N",
