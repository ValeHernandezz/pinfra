...
<title>Gestión de analista</title>
</head>
				...
				<div class="tableContenido">
					<table>
						...
						<tbody>
							...
							%>
							<tr>
								<td><%=oAnalista.getUsuario().getDocumento()%></td>
								<td><%=oAnalista.getUsuario().getNombres()%></td>
								<td><%=oAnalista.getUsuario().getApellidos()%></td>
								<td><%=oAnalista.getUsuario().getMailPersonal()%></td>
								<td><%=oAnalista.getUsuario().getMailInstitucional()%></td>
								<td><%=oAnalista.getUsuario().getGenero().getNombre()%></td>
								<td><%=oAnalista.getUsuario().getDepartamento().getNombre()%></td>
								<td><%=oAnalista.getUsuario().getLocalidad().getNombre()%></td>
								<td><%=oAnalista.getUsuario().getItr().getNombre()%></td>
